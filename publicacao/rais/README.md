...
|---|---|---|---|---|
| `rais_estab/` | Estabelecimentos declarantes da RAIS (um registro por CNPJ/ano) | 2007–2025 | 19 | 2.09 GB |
...
duckdb.sql('''
    ...
    FROM read_parquet('hf://datasets/Gianpedro/rais-microdados-traduzidos/dicionarios.parquet')
...
duckdb.sql('''
    ...
    FROM read_parquet(
        'hf://datasets/Gianpedro/rais-microdados-traduzidos/rais_estab/ano_particao=2019/*.parquet',
